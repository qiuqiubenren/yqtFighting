            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="subName">
                        <Input type="text" v-model="searchForm.subName" placeholder="请输入医院名称" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="subCode">
                        <Input type="text" v-model="searchForm.subCode" placeholder="请输入医院代码" clearable style="width: 200px" />
                    </Form-item>
                    ...
                    <Form-item style="position:fixed;right:50px;top:130px">
                        ...
                        <Modal v-model="modal1" title="使用教程">
                            <p>1.添加医院：点击添加后输入信息点击确认提交</p>
                            <p>2.编辑医院：点击编辑后输入信息点击确认提交</p>
                            <p>3.删除医院：点击删除后点击确定按钮</p>
                        </Modal>
                    </Form-item>
                </Form-item>
            </Form>
