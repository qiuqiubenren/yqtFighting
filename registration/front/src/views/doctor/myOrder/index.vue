...
<div class="search">
            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="doctorName">
                        <Input type="text" v-model="searchForm.doctorName" placeholder="陪诊员姓名" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="date">
                        <DatePicker placeholder="陪诊日期" @on-change="changeDate" clearable style="width: 200px"></DatePicker>
                    </Form-item>
    ...
    <Modal v-model="orderFindModal" width="950" title="查询陪诊员放号情况" footer-hide>
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
