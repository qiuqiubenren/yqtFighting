...
<div class="search">
        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="">
                        <Select v-model="searchForm.subjectId" placeholder="陪诊医院" style="width:200px">
    ...
    <Modal v-model="orderModal" width="750" title="陪诊员放号" ok-text="确认放号" @on-ok="addNumberFxFx">
        <Form :label-width="100" label-position="left">
            <Row>
                <FormItem label="陪诊员姓名">
